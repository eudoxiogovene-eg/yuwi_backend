...
import { quizInfo,quiz1} from "../conteudo/vocabulario/substantivos/casa_familia"
...
import {createQuizSeedSemArea} from "./quizSeed2"
...
async function seed(){
    ...
    if(!level){
        ...
        const dadosQuiz:Omit<QuizData,"id"|"area">={
    ...
    const quizId= await createQuizSeedSemArea(dadosQuiz)
